...
<!--project description-->
<div id="desc" data-desc="{{$project->description}}">
...
<div class="side-list">
   <ul id="list-2">
      <span class="font-para-15 color-darkblue font-normal">Recent Projects</span>
      <hr>
      @foreach($projects as $project)
      <li><p class="animated"><a href="{{ URL::to('projects/'.str_replace(' ', '_', $project->title)) }}">{{$project->title}}</a></p></li>
      <hr>
      @endforeach 
   </ul>
</div>

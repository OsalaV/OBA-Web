...
<button type="submit" class="ws-form-action-btn savbtn">Save Project</button>
</h2>
...
<div class="row">
<div class="col-md-12">
<button type="submit" class="ws-form-action-btn pull-right savbtn">Save Project</button>
</div>
</div>
</form>
